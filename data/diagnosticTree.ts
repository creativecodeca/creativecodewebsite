  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: 'disorganized-chaotic',
          label: 'DISORGANIZED AND CHAOTIC',
          level: 3,
          children: [
            {
              id: 'no-systems-organization',
              label: 'NO ORGANIZATIONAL SYSTEMS',
              level: 4,
              children: [
                { id: 'messy-files', label: 'Files and documents all over the place', level: 5, children: [] },
                { id: 'no-task-management', label: 'No task management system', level: 5, children: [] },
                { id: 'sticky-notes-everywhere', label: 'Relying on sticky notes and memory', level: 5, children: [] },
                { id: 'cant-find-things', label: "Can't find important things when needed", level: 5, children: [] },
                { id: 'duplicate-work', label: 'Redoing work because lost previous version', level: 5, children: [] },
              ],
            },
            {
              id: 'poor-prioritization',
              label: 'POOR PRIORITIZATION',
              level: 4,
              children: [
            ...
            {
              id: 'time-management-broken',
              label: 'TIME MANAGEMENT BROKEN',
              level: 4,
              children: [
            ...
            {
              id: 'communication-mess',
              label: 'COMMUNICATION CHAOS',
              level: 4,
              children: [
                { id: 'inbox-overflowing', label: 'Email inbox overflowing (hundreds/thousands unread)', level: 5, children: [] },
                { id: 'multiple-channels-mess', label: 'Messages scattered across too many channels', level: 5, children: [] },
                { id: 'losing-important-messages', label: 'Losing track of important messages', level: 5, children: [] },
                { id: 'no-follow-up-system', label: 'No follow-up system (things fall through cracks)', level: 5, children: [] },
              ],
            },
            {
              id: 'workspace-environment',
              label: 'PHYSICAL/DIGITAL WORKSPACE CLUTTERED',
              level: 4,
              children: [
                { id: 'physical-clutter', label: 'Physical workspace cluttered and distracting', level: 5, children: [] },
                { id: 'too-many-tabs', label: 'Dozens of browser tabs open constantly', level: 5, children: [] },
                { id: 'desktop-chaos', label: 'Computer desktop covered in files', level: 5, children: [] },
                { id: 'disorganized-tools', label: 'Too many tools and apps creating confusion', level: 5, children: [] },
              ],
            },
          ],
        },
        {
          id: 'burnout-energy',
          label: 'BURNOUT AND ENERGY DRAIN',
          level: 3,
          children: [
            {
              id: 'working-too-much',
              label: 'WORKING TOO MANY HOURS',
              level: 4,
              children: [
                { id: 'nights-weekends', label: 'Constantly working nights and weekends', level: 5, children: [] },
                { id: 'no-time-off', label: 'No vacations or breaks in months/years', level: 5, children: [] },
                { id: 'always-on-call', label: 'Always on call, never disconnect', level: 5, children: [] },
                { id: 'cant-stop-thinking', label: "Can't stop thinking about business", level: 5, children: [] },
              ],
            },
            {
              id: 'poor-boundaries',
              label: 'NO WORK-LIFE BOUNDARIES',
              level: 4,
              children: [
                { id: 'family-suffering', label: 'Relationships and family suffering', level: 5, children: [] },
                { id: 'no-hobbies', label: 'No time for hobbies or interests', level: 5, children: [] },
                { id: 'social-isolation', label: 'Socially isolated', level: 5, children: [] },
                { id: 'guilt-not-working', label: 'Feel guilty when not working', level: 5, children: [] },
              ],
            },
            {
              id: 'health-neglected',
              label: 'HEALTH DETERIORATING',
              level: 4,
              children: [
                { id: 'chronic-stress', label: 'Chronic stress and anxiety', level: 5, children: [] },
                { id: 'sleep-deprived', label: 'Sleep deprived', level: 5, children: [] },
                { id: 'poor-diet-exercise', label: 'Poor diet and no exercise', level: 5, children: [] },
                { id: 'physical-symptoms', label: 'Physical symptoms (headaches, fatigue, illness)', level: 5, children: [] },
              ],
            },
            {
              ...
              level: 4,
              children: [
                { id: 'lost-motivation', label: 'Lost motivation and passion', level: 5, children: [] },
                { id: 'cynical-negative', label: 'Becoming cynical or negative', level: 5, children: [] },
                { id: 'decision-fatigue', label: 'Decision fatigue', level: 5, children: [] },
                { id: 'feel-trapped', label: 'Feel trapped in own business', level: 5, children: [] },
              ],
            },
          ],
        },
        {
          id: 'skills-knowledge-gap',
          label: 'LACK CRITICAL SKILLS OR KNOWLEDGE',
          level: 3,
          children: [
            {
              id: 'no-business-skills',
              label: 'MISSING BUSINESS FUNDAMENTALS',
              level: 4,
              children: [
                { id: 'no-financial-literacy', label: "Don't understand financials/numbers", level: 5, children: [] },
                { id: 'no-hiring-skills', label: "Don't know how to hire or manage people", level: 5, children: [] },
                { id: 'no-sales-skills', label: "Can't sell or negotiate effectively", level: 5, children: [] },
                { id: 'no-systems-thinking', label: 'No systems thinking or strategic planning', level: 5, children: [] },
              ],
            },
            {
              id: 'no-marketing-skills',
              label: 'WEAK MARKETING KNOWLEDGE',
              level: 4,
              children: [
                { id: 'dont-know-target', label: "Don't know how to identify target market", level: 5, children: [] },
                { id: 'no-positioning', label: "Can't articulate unique value proposition", level: 5, children: [] },
                { id: 'no-digital-marketing', label: 'No digital marketing skills', level: 5, children: [] },
                { id: 'no-content-creation', label: "Don't know how to create effective content", level: 5, children: [] },
              ],
            },
            {
              id: 'learning-too-slow',
              label: 'NOT LEARNING FAST ENOUGH',
              level: 4,
              children: [
                { id: 'no-mentors', label: 'No mentors or advisors', level: 5, children: [] },
                { id: 'no-peer-network', label: 'No peer network of other founders', level: 5, children: [] },
                { id: 'no-time-learn', label: 'No time to learn new skills', level: 5, children: [] },
                { id: 'wrong-learning-sources', label: 'Learning from wrong sources (outdated/irrelevant)', level: 5, children: [] },
              ],
            },
            {
              id: 'mindset-blocks',
              label: 'MINDSET HOLDING BACK',
              level: 4,
              children: [
                { id: 'imposter-syndrome', label: 'Imposter syndrome', level: 5, children: [] },
                { id: 'perfectionism', label: 'Perfectionism preventing action', level: 5, children: [] },
                { id: 'fear-failure', label: 'Fear of failure paralyzing decisions', level: 5, children: [] },
                { id: 'scarcity-mindset', label: 'Scarcity mindset', level: 5, children: [] },
                { id: 'cant-think-bigger', label: "Can't think big enough", level: 5, children: [] },
              ],
            },
          ],
        },
