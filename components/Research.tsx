...
const Research: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-[#020202] text-white overflow-hidden">
      {/* Left Sidebar - Fixed Chapter Navigation */}
      <div className="hidden lg:block w-80 absolute left-0 top-20 bottom-0 border-r border-white/10 bg-[#020202] z-50 overflow-hidden">
      ...
      <div className="absolute top-20 bottom-0 right-0 left-0 lg:left-80 overflow-y-auto">
