...
const BuyStandardWebsite: React.FC = () => {
    useEffect(() => {
        // Load Stripe script
                ...
                <section className="pt-32 pb-12 px-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className="bg-indigo-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                                Most Popular
                            </div>
                        </div>
                        <p className="text-xl text-slate-400 mb-8">
                            Our most popular package - a custom-designed website with SEO optimization and fast delivery.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-12 px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            {/* Left Column - Details */}
                            <div>
                                <div className="bg-[#0a0a0a] border border-indigo-500/30 rounded-2xl p-8 mb-8 shadow-[0_0_40px_rgba(99,102,241,0.1)]">
                                    <div className="mb-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex gap-3 text-slate-300">
                                            ...
                                            <span>4 Pages (Home, About, Services, Contact)</span>
                                        </div>
                                        <div className="flex gap-3 text-slate-300">
                                            <Check className="w-5 h-5 text-indigo-500 shrink-0 mt-0.5" />
                            ...
                            <div>
                                <div className="bg-[#0a0a0a] border border-indigo-500/30 rounded-2xl p-8 sticky top-24 shadow-[0_0_40px_rgba(99,102,241,0.1)]">
                                    <h3 className="text-2xl font-bold text-white mb-6">Complete Your Purchase</h3>
                                    <div className="flex justify-center">
                                        <stripe-buy-button
                                            buy-button-id="buy_btn_1SLtAVBx7uHSBjgp4V67pRNJ"
...
export default BuyStandardWebsite;
