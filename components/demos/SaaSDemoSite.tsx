      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 blur-3xl"></div>
            <div className="relative bg-[#0a0a0a] rounded-2xl border border-white/10 p-8 shadow-2xl">
              {/* Dashboard Header */}
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-4">
                  <div className="w-32 h-8 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded"></div>
                  <div className="flex gap-2">
                    {['Projects', 'Tasks', 'Team', 'Reports'].map((tab) => (
                      <div key={tab} className="px-4 py-2 bg-white/5 rounded text-sm text-slate-400">{tab}</div>
                    ))}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-4 gap-4 mb-8">
                {[
                  ...
                  { label: 'On Time Rate', value: '94%', icon: TrendingUp }
                ].map((stat, i) => (
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold">Project Velocity</h3>
                  <div className="flex gap-2">
                    <div className="px-3 py-1 bg-white/5 rounded text-xs">Week</div>
                    <div className="px-3 py-1 bg-blue-500/20 rounded text-xs text-blue-400">Month</div>
                    <div className="px-3 py-1 bg-white/5 rounded text-xs">Year</div>
                  </div>
                </div>
                <div className="h-48 flex items-end gap-2">
                  {[40, 65, 45, 80, 55, 90, 70, 85, 60, 95, 75, 88].map((height, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-blue-500 to-cyan-500 rounded-t" style={{ height: `${height}%` }}></div>
                  ))}
                </div>
              </div>
            </div>
